...
local function set_wallpaper(s)
    wp_path = "/home/serega/Pictures/wallpapers/"
...
--     awful.key({ modkey,           }, "#127", awesome.quit,
...
--               {description = "quit awesome", group = "awesome"}),
    ...
    awful.key({ modkey,           }, "r", function () awful.util.spawn_with_shell("dmenu_path | rofi -dmenu -p run | ${SHELL:-\"/bin/sh\"} &") end),
    ...
    awful.key({"Control"}, "Print", function () awful.util.spawn({"flameshot", "full", "-c"}) end)
)
